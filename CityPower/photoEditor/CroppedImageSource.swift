...
final class CroppedImageSource: ImageSource {
    ...
    private let processingQueue = DispatchQueue(label: "com.CityPower.CroppedImageSource.processingQueue", qos: .userInitiated,
    ...
    private func newScaledImage(
        source: CGImage, withOrientation orientation: ExifOrientation,
        toSize size: CGSize, withQuality quality: CGInterpolationQuality) -> CGImage? {
